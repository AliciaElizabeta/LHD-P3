 ...
 * @brief Clase que contiene herramientas y funcionalidades
 * del proyecto Exposito
 */
...
public class ExpositoUtilities {
     ...
     * @param Dos matrices a y b
     * @return Una matriz que puede ser [0][0] si no son multiplicables
     */
    ...
    public static String getFormat(double value, int zeros) {
        String format;
        StringBuilder formatBld = new StringBuilder("0.");
        for (int i = 0; i < zeros; i++) {
            formatBld.append( "0");
        }
        format = formatBld.toString();
